  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading" style="padding-top: 20px;">
        ...
        <div class="line"></div>
        <p><span><strong>E</strong></span>staremos muy felices de contestar a tus dudas y/o peticiones</p>
      </div>
    </div>
      ...
      <div class="col-md-6 col-sm-6 contact-sec-1">
        ...
        <ul class="contact-form">
          <li><i class="fa fa-map-marker"></i>
            <h6><strong>Dirección:</strong> Av. Insurgentes 601
                Col. Nápoles, Benito Juárez
                Ciudad de México, México  </h6>
          </li>
          <li><i class="fa fa-envelope"></i>
            <h6><strong>Nuestro correo:</strong> <a href="#">contacto@turing-ia.com</a></h6>
          </li>
          <li><i class="fa fa-phone"></i>
            <h6><strong>Telefono:</strong> +52 (722) 936-96-65 </h6>
          </li>
        </ul>
      </div>
